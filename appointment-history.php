...
<html lang="en">
	<head>
		<title><?php echo $usuarioHistorial ;?></title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><?php echo $usuarioHistorial ;?></h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User </span>
									...
									<li class="active">
										<span><?php echo $usuarioHistorial ;?></span>
									</li>
								</ol>
							</div>
						</section>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">Doctor nombre</th>
